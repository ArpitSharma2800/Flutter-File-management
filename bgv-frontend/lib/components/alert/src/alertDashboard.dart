...
import 'package:bgv/models/alertServices.dart';
...
class AlertDashbaord extends StatefulWidget {
  AlertDashbaord({Key key}) : super(key: key);

  @override
  _AlertDashbaordState createState() => _AlertDashbaordState();
}

class _AlertDashbaordState extends State<AlertDashbaord> {
  bool loading = true;
  bool hasData = false;
  List<AlertClass> dataList;
  ...
  void setupApi() async {
    ...
    await AlertServices.getalert().then((v) {
      setState(() {
        dataList = v;
        try {
              ...
              return ListTile(
                  ...
                  trailing: Wrap(
                    ...
                    children: [
                      ...
                      //   color: Colors.red,
                      //   onPressed: () {
                      //     // showAlertDialog(context, dataList[index].fileName,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          showAlertDialogImage(
                              context, dataList[index].fileName);
                        },
                      ),
                    ],
                  ),
                  title: Text(
                      " Alert genrated on file : ${dataList[index].fileName}"));
            }),
      ),
    );
  }
